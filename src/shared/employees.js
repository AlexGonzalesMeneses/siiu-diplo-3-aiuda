export const EMPLOYEES = [
  {
    ...
    jobCode: 'CEO',
    featured: true,
    jobDescription: 'El CEO, esta encargado de dirigir la empresa para conseguir los objetivos alineados con las estrategias de la ' +
      'empresa. Su rol fundamental es marcar las estrategias a seguir cuidando que los indicadores relacionados se cumplan y de ser ' +
      'necesario proponer nuevas estrategias que permitan a la empresa adaptarse al mercado.'
  },
  {
    id: 1,
    name: 'Ben Affleck',
